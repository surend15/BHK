...
export default function Ecofri ({navigation}){
...
console.log("ecofriend",response);
  ...
  return (
       <View style={{flex:1,backgroundColor:"white"}}>
        <View style={{width:"100%",height: "12%",
                           ...
                           alignItems:"center"}}>
                             <Text style={{color:"white",fontSize:25,justifyContent:"center",fontWeight:"bold",marginTop:"10%"}}>ECO-FRIENDLY HOUSE</Text>
                             <Add name='export' size={32} style={{marginLeft:"80%"}} onPress={()=>{setsample(true);setwhat('eco')}}/>
        </View> 
        <FlatList
        data={data}
        renderItem={(item)=>(
