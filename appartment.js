...
console.log("appartment",response);
  ...
  return (
       <View style={{flex:1,backgroundColor:"white"}}>
        <View style={{width:"100%",height: "12%",
                           ...
                           alignItems:"center"}}>
                             <Text style={{color:"white",fontSize:25,justifyContent:"center",fontWeight:"bold",marginTop:"10%"}}>APPARTMENT</Text>
                             <Add name='export' size={32} style={{marginLeft:"80%"}} onPress={()=>{setsample(true);setwhat('appart')}}/>
        </View> 
        <FlatList
        data={data}
        renderItem={(item)=>(
              ...
              <Close name='close' style={{marginLeft:"80%",marginBottom:"40%"}} size={32} onPress = {() => {  
                  setisVisible(!isVisible)}}/> 
                   <Image style={{marginBottom:10,height:200,width:'100%',justifyContent:"center"}} source={{uri:uril+imgv.print}}/>
                    ...
                    <Text onPress={(e)=>download(e)}>download</Text>
